...
create table icons (id integer not null auto_increment, iconurl varchar(255), primary key (id)) type=MyISAM
create table image (id integer not null auto_increment, imageurl varchar(255), authors_author_id integer, icons_icon_id integer, locations_location_id integer, primary key (id)) type=MyISAM
